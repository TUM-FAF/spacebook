              ...
              <div className="content-center">
                ...
                <div>
                  <div className="bg-accent p-4 flex flex-col justify-between">
                    <p className="font-ibm text-text-dark font-normal text-[24px]">{props.dayPicture.title}</p>
                  </div>
                ...
                <p className="font-ibm text-theme text-[16px] mt-[16px]">{props.dayPicture.explanation}</p>
              </div>
            </div>
          </div>
        </div>
